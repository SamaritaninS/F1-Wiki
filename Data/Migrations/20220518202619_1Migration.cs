        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamEntry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Championships = table.Column<int>(type: "int", nullable: false),
                    ...
                    Preview = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Img = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirstDriverId = table.Column<int>(type: "int", nullable: true),
                    SecondDriverId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
